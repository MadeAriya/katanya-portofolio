...
export default function Home() {
  ...
  return (
    <main className="relative z-30">
      ...
      <section className="flex flex-col justify-center items-center mt-30 gap-4 px-4 md:px-0 max-w-4xl mx-auto">
        <h6 className="font-montserrat font-extrabold text-xs md:text-sm text-white">{t('hero.tagline')}</h6>
        <motion.h1
          className="font-montserrat font-extrabold text-center text-5xl md:text-7xl text-white max-w-3xl mx-auto md:max-w-4xl"
          variants={container}
          initial="hidden"
          animate="show"
        >
        ...
        <p className="font-montserrat text-sm md:p-5 md:text-xl text-center text-white max-w-xl mx-auto">{ t('hero.desc') }</p>
        <LottieScrollWrapper/>
      </section>
